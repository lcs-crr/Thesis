![repo_cover](docs/assets/test.svg)

# PhD Thesis Repository

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT) ![Thesis Status](https://img.shields.io/badge/Thesis-defended-green)
...
The documentation corresponding to this repository can be read [here](https://lcs_crr.codeberg.page/Thesis/).

## Dissertation
A permanent link to the dissertation and propositions can be found [here]().
