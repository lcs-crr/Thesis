...
from model_garden.tevae import KLAnnealing, TeVAE_Encoder, TeVAE_Decoder, MA, TeVAE
...
for fold_idx in range(3):
    for split in ["1day", "1week", "2weeks", "3weeks", "4weeks"]:
        data_load_path = os.path.join(
            data_path, "2_preprocessed", "fold_" + str(fold_idx), split
        )
        model_save_path = os.path.join(
            model_path, MODEL_NAME + "_" + split + "_" + str(fold_idx) + "_1"
